    ...
    <footer>
      <div className="container">
        <div className="row pt-5">
          ...
          <div className="col-3">
            <h6 className="mb-4">Accreditations</h6>
            <p>Superbadges</p>
            <p>Certifications</p>
            <p>Gerer les certifications</p>
            <p>Verifier les certifications</p>
            <p>
              Suivre gratuitement des cours de preparations a la certification
            </p>
          </div>
          <div className="col-3">
